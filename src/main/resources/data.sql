insert into user (email, password, phone, reg_date, update_date, user_name)
values ('test1@test.com', '1111', '010-1111-1111', now(), null, '홍길동');
insert into user (email, password, phone, reg_date, update_date, user_name)
values ('test2@test.com', '2222', '010-2222-2222', now(), null, '손흥민');
insert into user (email, password, phone, reg_date, update_date, user_name)
values ('test3@test.com', '3333', '010-3333-3333', now(), null, '봉준호');
insert into user (email, password, phone, reg_date, update_date, user_name)
values ('test4@test.com', '4444', '010-4444-4444', now(), null, '박재범');
