...
public class ApiBoardController {
    ...
    public ResponseEntity<?> boardHits(@PathVariable Long id, @RequestHeader("Z-TOKEN") String token) {
        String email = "";
        try {
    ...
    public ResponseEntity<?> boardLike(@PathVariable Long id, @RequestHeader("Z-TOKEN") String token) {
        String email = "";
        try {
            email = JWTUtils.getIssuer(token);
        } catch (JWTVerificationException e) {
    ...
    public ResponseEntity<?> boardUnLike(@PathVariable Long id, @RequestHeader("Z-TOKEN") String token) {
        String email = "";
        try {
            email = JWTUtils.getIssuer(token);
        } catch (JWTVerificationException e) {
    ...
    public ResponseEntity<?> boardBadReport(@PathVariable Long id, @RequestHeader("Z-TOKEN") String token, @RequestBody BoardBadReportInput boardBadReportInput) {
        String email = "";
        try {
            email = JWTUtils.getIssuer(token);
        } catch (JWTVerificationException e) {
